...
{    
    ...
    public function all_brand_product(){
        $this->Authlogin();
        $all_brand_product = Brand::orderBy('brand_id','DESC')->get(); //paninate(5)
    ...
    public function save_brand_product(Request $request){
        ...
        $brand->save();
        //  $data = array();
        //  $data ['brand_name'] = $request -> brand_product_name ;// tên name của trường; //tên của cột trong mysql
    ...
    public function edit_brand_product($brand_product_id){   //function chỉnh sửa danh mục sản phẩm
        $this->Authlogin();
    ...
    public function update_brand_product(Request $request, $brand_product_id)  { //function cập nhật danh mục sản phẩm
        $this->Authlogin();
        $data = $request->all();
    ...
    public function show_brand_home($brand_id){
        ...
        $brand_by_id = DB::table('product')->join('brand_product','product.brand_id','=',
        'brand_product.brand_id')->where('product.brand_id',$brand_id)
        ->paginate(9);
