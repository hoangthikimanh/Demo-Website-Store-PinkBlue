...
{   
    ...
    public function save_category_product(Request $request){
        $this->Authlogin();
         $data = array();
         $data ['category_name'] = $request -> category_product_name ;// tên name của trường; //tên của cột trong mysql
    ...
    public function edit_category_product($category_product_id){   //function chỉnh sửa danh mục sản phẩm
        $this->Authlogin();
    ...
    public function update_category_product(Request $request, $category_product_id)  { //function cập nhật danh mục sản phẩm
        $this->Authlogin();
        $data = array();
        $data ['category_name'] = $request -> category_product_name ;// tên name của trường; //tên của cột trong mysql
         $data ['category_desc'] = $request -> category_product_desc ;
    ...
    ->paginate(9); // Sử dụng paginate thay vì get
