                    ...
                    <div class="position-center">
                        ...
                        <form role="form" action="{{URL::to('/update-product/'.$pro->product_id)}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                id="exampleInputEmail1" value="{{$pro->product_code}}">
                            </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            id="exampleInputEmail1"value="{{$pro->product_image}}" >
                            <img src="{{URL::to('public/uploads/product/'.$pro->product_image)}}"height = "100" width="100">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Mô tả sản phẩm</label>
                            <textarea style="resize:none" row = "8" class="form-control" id="editor1" name="product_desc" id="exampleInputPassword1" >{{$pro->product_desc}}
                                </textarea>
                        </div>
                        <div class="form-group">
                        ...
                        {{-- <div class="form-group">
                            ...
                            <input type="text" name="product_price" class="form-control" 
                            id="exampleInputEmail1"value="{{$pro->product_qty}}" >
                        </div>
                         --}}
                        <div class="form-group">
