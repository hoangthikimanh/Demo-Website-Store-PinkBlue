...
<body>
	...
	<section>
		<div class="container">
			<div class="row">
				<div class="row">
					<div class="col-sm-3" style="padding: 50px 30px; position: relative;border: 1px solid #bbb7b7; border-radius: 32px 0px; font-size: 16px;margin-top:0.5cm"> 
						<div class="left-sidebar">
							...
							<div class="panel-group " id="accordian"><!--category-productsr-->
								<h4 class="panel-title">
									<a href="{{ URL::to('/customer-info') }}"><strong>Thông tin tài khoản</strong></a>
								  </h4>
								{{-- @foreach ($category as $key => $cate) --}}
							...
							<div class="panel-group " id="accordian"><!--category-productsr-->
								<h4 class="panel-title">
									<a href="{{ URL::to('/order-list') }}"><strong>Quản lý đơn hàng</strong></a>
								  </h4>
								{{-- @foreach ($category as $key => $cate) --}}
							...
							<div class="panel-group " id="accordian"><!--category-productsr-->
								...
								?>
								<a href="{{URL::to('/logout-checkout')}}"></i><strong>Đăng xuất</strong> </a>
								
								<?php 

								}else {
								?>
								<a href="{{URL::to('/login-checkout')}}"></i><strong>Đăng nhập</strong> </a>
								<?php 
								}
								?>
							...
							<div class="brands_products">
								...
								<div class="brands-name">
									<ul class="nav nav-pills nav-stacked">
										@foreach ($brand as $key => $brand)
										<li><a href="{{URL::to('/thuong-hieu-san-pham/'.$brand->brand_id)}}"> <span class="pull-right"></span><h5>{{$brand->brand_name}}</h5></a></li>
										@endforeach
