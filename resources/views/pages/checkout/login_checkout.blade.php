                                ...
                                <div class="col-sm-4 col-sm-offset-1">
                                    <div class="login-form"><!--login form-->
                                        ...
                                        <form action="{{URL::to('/login-customer')}}" method="POST">
                                            ...
                                            <button type="" class="btn btn-default "style="font-size: 16px;
                                            border-radius: 0;
                                            border: medium none;
                                            font-weight: bold;border-top-left-radius: 0.6rem;
                                            border-top-right-radius: 0.6rem;
                                            border-bottom-right-radius: 0.6rem;
                                            border-bottom-left-radius: 0.6rem;
                                            height: 38px">Đăng nhập</button>
                                ...
                                <div class="col-sm-6">
                                    <div class="signup-form"><!--sign up form-->
                                        ...
                                        <form action="{{URL::to('/add-customer')}}" method="POST">
                                            ...
                                            <input type="email" name="customer_email"  placeholder="Địa chỉ email" data-validation="email" data-validation-error-msg="Bạn chưa nhập email">
                                            <input type="password" name="customer_password"  placeholder="Mật khẩu"data-validation="required" 
                                            data-validation-error-msg="Bạn chưa nhập mật khẩu"/>
                                            <input type="text" name="customer_phone" placeholder="Số điện thoại"/>
                                            <input type="text" name="customer_address" placeholder="Địa chỉ"/>
                                            
                                            <button type="submit" class="btn btn-default "style="font-size: 16px;
                                            
                                            border: medium none;
                                            font-weight: bold;border-top-left-radius: 0.6rem;
                        border-top-right-radius: 0.6rem;
                        border-bottom-right-radius: 0.6rem;
                        border-bottom-left-radius: 0.6rem;">Đăng ký</button>
