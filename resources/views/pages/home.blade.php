		...
		<div class="container">
			<div class="row">
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							...
							<div class="item">
								...
								<div class="col-sm-12">
									<img src="{{asset('public/frontend/images/bia2.jpg')}}" class="girl img-responsive" alt="" />
                ...
                <div class="row" style="margin-top:20px">
                    ...
                    <div class="col-sm-4">
                        <img src={{asset('public/frontend/images/uudai.jpg')}} alt="Thumbnail 1" class="img-responsive">
                    </div>
                    <div class="col-sm-4">
                        <img src={{asset('public/frontend/images/uudai1.jpg')}} alt="Thumbnail 2" class="img-responsive">
                    </div>
                    <div class="col-sm-4">
                        <img src={{asset('public/frontend/images/uudai2.jpg')}} alt="Thumbnail 3" class="img-responsive">
                    </div>
                </div>
			</div>
		</div>
                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                    <div class="productinfo text-center">
                                        ...
                                        <input type="hidden" value="{{$product->product_code}}" class="cart_product_code_{{$product->product_id}}">
